...
public final class Main {
  ...
  private static final int EXIT_CODE_ARGUMENT_ERROR = 1;
  private static final int EXIT_CODE_CLIENT_ERROR = 2;
  private static final int EXIT_CODE_UNKNOWN_ERROR = 3;
  ...
  private void backfillList() {
    ...
    styxClient.backfillList(component, workflow, true, false)
        .whenComplete(throwableChecker)
  ...
  private void workflowShow() {
    ...
    CompletableFuture<WorkflowState> workflowStateFuture =
